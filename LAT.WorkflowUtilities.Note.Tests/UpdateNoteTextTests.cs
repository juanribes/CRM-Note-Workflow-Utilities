...
namespace LAT.WorkflowUtilities.Note.Tests
{
	...
	public class UpdateNoteTextTests
	{
		...
		public UpdateNoteTextTests()
		{
			...
			_namespaceClassAssembly = "LAT.WorkflowUtilities.Note.UpdateNoteText" + ", " + "LAT.WorkflowUtilities.Note";
		}
		#endregion
		...
		public void SetText()
		{
			...
			//Test(s)
			Assert.AreEqual(expected, output["UpdatedText"]);
		}
