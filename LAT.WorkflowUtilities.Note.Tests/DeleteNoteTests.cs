...
namespace LAT.WorkflowUtilities.Note.Tests
{
	...
	public class DeleteNoteTests
	{
		...
		public DeleteNoteTests()
		{
			...
			_namespaceClassAssembly = "LAT.WorkflowUtilities.Note.DeleteNote" + ", " + "LAT.WorkflowUtilities.Note";
		}
		#endregion
		...
		public void DeleteNote()
		{
			...
			{
				{ "NoteToDelete", new EntityReference("annotation", Guid.NewGuid()) }
			};
			...
			//Test(s)
			Assert.AreEqual(expected, output["WasNoteDeleted"]);
		}
