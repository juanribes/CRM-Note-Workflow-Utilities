...
namespace LAT.WorkflowUtilities.Note.Tests
{
	...
	public class UpdateNoteTitleTests
	{
		...
		public UpdateNoteTitleTests()
		{
			...
			_namespaceClassAssembly = "LAT.WorkflowUtilities.Note.UpdateNoteTitle" + ", " + "LAT.WorkflowUtilities.Note";
		}
		#endregion
		...
		public void SetTitle()
		{
			...
			{
				{ "NoteToUpdate", new EntityReference("annotation", Guid.NewGuid()) },
				{ "NewTitle", "test" }
			};
			...
			//Test(s)
			Assert.AreEqual(expected, output["UpdatedTitle"]);
		}
